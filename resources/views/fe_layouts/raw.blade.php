                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="page__title-wrapper mt-110">
                            <h3 class="page__title">XII A</h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Mapel Room</li>
                                    <li class="breadcrumb-item active" aria-current="page">Intan Permata Sari</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item white-bg mb-30 fix">
                                                ...
                                                <div class="course__content">
                                                    ...
                                                    <h3 class="course__title"><a href="course-details.html">Bases
                                                            Matemáticas dios Álgebra Ecuacion</a></h3>
                                                    <div class="course__teacher d-flex align-items-center">
                                                        <div class="course__teacher-thumb mr-15">
                                                            <img src="assets/img/course/teacher/teacher-7.jpg"
                                                                alt="">
                                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item white-bg mb-30 fix">
                                                ...
                                                <div class="course__content">
                                                    ...
                                                    <div class="course__teacher d-flex align-items-center">
                                                        <div class="course__teacher-thumb mr-15">
                                                            <img src="assets/img/course/teacher/teacher-8.jpg"
                                                                alt="">
                                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item white-bg mb-30 fix">
                                                ...
                                                <div class="course__content">
                                                    ...
                                                    <h3 class="course__title"><a href="course-details.html">Build your
                                                            media and Public presence</a></h3>
                                                    <div class="course__teacher d-flex align-items-center">
                                                        <div class="course__teacher-thumb mr-15">
                                                            <img src="assets/img/course/teacher/teacher-5.jpg"
                                                                alt="">
                                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item white-bg mb-30 fix">
                                                ...
                                                <div class="course__content">
                                                    ...
                                                    <h3 class="course__title"><a href="course-details.html">Creative
                                                            writing through Storytelling</a></h3>
                                                    <div class="course__teacher d-flex align-items-center">
                                                        <div class="course__teacher-thumb mr-15">
                                                            <img src="assets/img/course/teacher/teacher-6.jpg"
                                                                alt="">
                                                        </div>
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                            <div class="course__item white-bg mb-30 fix">
                                                ...
                                                <div class="course__content">
                                                    ...
                                                    <div class="course__teacher d-flex align-items-center">
                                                        <div class="course__teacher-thumb mr-15">
                                                            <img src="assets/img/course/teacher/teacher-9.jpg"
                                                                alt="">
                                                        </div>
                                                            ...
                                                            <div class="course__content course__content-3">
                                                                <div class="course__meta d-flex align-items-center">
                                                                    <div class="course__lesson mr-20">
                                                                        <span><i class="far fa-book-alt"></i>10
                                                                            Dokumen</span>
                                                                    </div>
                                                                </div>
                                                                <h3 class="course__title course__title-3">
                                                                    <a href="course-details.html">Rekayasa Perangkat
                                                                        Lunak</a>
                                                                </h3>
                                                                <div class="course__summary">
                                                                    <p>Matapelajaran RPL untuk kelas XII A. Selamat
                                                                        Belajar, jangan lupa untuk mengunduh materi yang
                                                                        sudah kami sediakan untuk menunjang pembelajaran
                                                                        kalian di rumah.
                                                                    </p>
                                                                </div>
                                                                <div class="course__teacher d-flex align-items-center">
                                                                    ...
                                                                    <h6><a href="instructor-details.html">Pak Raden</a>
                                                                    </h6>
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div class="course__status">
                                                                    <span>Latihan soal baru ditambahkan</span>
                                                                </div>
                                                                <div class="course__btn">
                                                                    <a href="course-details.html" class="link-btn">
                                                                        Know Details
                                                ...
                                                <div class="row gx-0">
                                                    <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                        <div
                                                            ...
                                                            <div class="course__tag">
                                                                <a href="#" class="sky-blue">Matematika</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-8 col-xl-8 col-lg-8">
                                                        <div class="course__right">
                                                            <div class="course__content course__content-3">
                                                                <div class="course__meta d-flex align-items-center">
                                                                    <div class="course__lesson mr-20">
                                                                        <span><i class="far fa-book-alt"></i>72
                                                                            Dokumen</span>
                                                                    </div>
                                                                </div>
                                                                <h3 class="course__title course__title-3">
                                                                    <a href="course-details.html">Matematika</a>
                                                                </h3>
                                                                <div class="course__summary">
                                                                    <p>Mata pelajaran matematika untuk kelas XII A.
                                                                        Selamat belajar , jangan lupa untuk mengunduh
                                                                        materi yang
                                                                        sudah kami sediakan untuk menunjang pembelajaran
                                                                        kalian di rumah.</p>
                                                                </div>
                                                                <div class="course__teacher d-flex align-items-center">
                                                                    ...
                                                                    <h6><a href="instructor-details.html">Bu Susi</a>
                                                                    </h6>
                                                                </div>
                                                            </div>
                                                            <div
                                                                class="course__more course__more-2 d-flex justify-content-between align-items-center">
                                                                <div class="course__status d-flex align-items-center">
                                                                    <span class="sky-blue">Dokumen baru telah
                                                                        ditambahkan</span>
                                                                </div>
                                                                <div class="course__btn">
                                                                    <a href="course-details.html" class="link-btn">
                                                ...
                                                <div class="row gx-0">
                                                    <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                        <div
                                                            ...
                                                            <div class="course__tag">
                                                                <a href="#" class="blue-2">Bahasa Indonesia</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xxl-8 col-xl-8 col-lg-8">
                                                        <div class="course__right">
                                                            <div class="course__content course__content-3">
                                                                <div class="course__meta d-flex align-items-center">
                                                                    <div class="course__lesson mr-20">
                                                                        <span><i class="far fa-book-alt"></i>14
                                                                            Dokumen</span>
                                                                    </div>
                                                                </div>
                                                                <h3 class="course__title course__title-3">
                                                                    <a href="course-details.html">Bahasa Indonesia</a>
                                                                </h3>
                                                                <div class="course__summary">
                                                                    <p>Matapelajaran bahasa indonesia untuk kelas XII.
                                                                        Selamat belajar , jangan lupa untuk mengunduh
                                                                        materi yang
                                                                        sudah kami sediakan untuk menunjang pembelajaran
                                                                        kalian di rumah.</p>
                                                                ...
                                                                <div class="course__teacher d-flex align-items-center">
                                                                    ...
                                                                    <h6><a href="instructor-details.html">Pak Elon
                                                                            Musk</a></h6>
                                                                </div>
                                                            </div>
                                                            <div
